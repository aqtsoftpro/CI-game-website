                 ...
                 <div class="card-box">
                        <div class="row">
                            ...
                            <?php } else { ?>
                                <div class="well">
                                    <span>
                                        <!--<a id="login_for_comment" href="#<?php //echo base_url('/login/');?>"><?php echo $this->lang->line('login');?></a>-->
                                        <button class="btn btn-default" data-toggle="modal" data-target="#modalForm">
                                            <?php echo $this->lang->line('login');?>
                                        </button>
                                        <?php echo $this->lang->line('loginForComment'); ?></span>
                                </div>
                            <?php } ?>
...
window.onload = function() {
    ...
    $("#submitLogin").click(function(e){
        ...
        $.ajax({
            type:'POST',
            url:'<?php echo base_url('login_for_comment');?>',
            ...
            <div class="wrapper-page">
                <div class="landing-box">
                    ...
                    <div class="panel-body">
                        ...
                        <div id="responseError" class="text-center"></div>

                        <form id="formLogin" class="form-horizontal m-t-20" action="<?php echo site_url('login/'); ?>" method="post">
                            ...
                            <div class="form-group text-center m-t-40">
                                <div class="col-xs-12">
                                    <button id="submitLogin" class="btn btn-primary w-lg text-uppercase waves-effect waves-light" type="submit"><?php echo $this->lang->line('login'); ?></button>
                                </div>
                            </div>
                            ...
                            <div class="form-group m-t-30 m-b-0">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 text-center no-account">

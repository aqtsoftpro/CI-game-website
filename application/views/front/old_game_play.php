<section>
	<div class="container container-fluid">
		...
		<div class="row game_play">
		<div class="col-lg-3 col-sm-12 col-xs-12 col-md-3 text-center">
        <img src="<?php echo base_url('/uploads/images/adds.jpg')?>">
        </div>
			<div class="col-lg- col-sm-12 col-xs-12 col-md-6">
				...
				<?php } else { ?>
					<div id="gameBox">
						<iframe id="object" src="<?php if(isset($embed)) echo $embed;  ?>" type="application/vnd.adobe.flash-movie" scrolling="no" frameborder="0"></iframe>
					</div>
				<?php } ?>
				</div>
			</div>
			<div class="col-lg-3 col-sm-12 col-xs-12 col-md-3 text-center">
            <img src="<?php echo base_url('/uploads/images/dummy.jpg')?>">
            </div>
		</div>
	...
	<div class="row">
			...
			<div class="col-sm-12 col-xs-12 col-md-6 col-lg-6 game_details">
				<div class="row">
					<div class="col-md-6">
					...
					<div class="col-md-3 text-center">
						<p>Played 35,785 Times</p>
						<i class="fa fa-thumbs-up"></i> 75 <i class="fa fa-thumbs-down"></i> 10
					</div>
					<div class="col-md-3 text-center">
				...
				<div class="row">
					<div class="col-md-12"> Related Games</div>
				</div>
				<div class="row">
					<div class="col-md-12"> Recommended Games</div>
				</div>
			</div>
			<div class="col-sm-12 col-xs-12 col-md-3 col-lg-3">
				Right

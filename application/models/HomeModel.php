...
class HomeModel extends CI_Model
{
    ...
    public function getBlocsGame($getOrder, $getPag)
    {
        ...
        if($getOrder === 'rated') {
            ...
            $sql = "SELECT id, title, url, id_category, played, note, image, date_upload,video_url,feature_order FROM 2d_games WHERE status = 1 and is_feature=1 ORDER BY feature_order DESC";
        } 
        // elseif(!empty($search)) {
